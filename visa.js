...
let c = new Crawler({
  ...
  callback: function(error, res, done) {
    if (error) {
      ...
      let $ = res.$;
      let val = $(
        "#er_result_table > p.currency-convertion-result.h2 > strong"
      ).text();
      var regex = /[+-]?\d+(?:\.\d+)?/g;
...
function addCrawl(date, fromCurrency, toCurrency) {
  ...
  c.queue({
    ...
    headers: {
      ...
      referer:
        "https://usa.visa.com/support/consumer/travel-support/exchange-rate-calculator.html/?amount=1&fee=0.0&exchangedate=08%2F20%2F2018&fromCurr=USD&toCurr=CAD&submitButton=Calculate+exchange+rate",
      "accept-encoding": "gzip, deflate, br",
      "accept-language": "en-CA,en;q=0.9,en-US;q=0.8",
      cookie:
        "visaAnonCookie=dc32c517ac3a0000fda27a5bae010000442a0100; AKA_A2=A; visaCookie=dc32c517ac3a00000ba27a5b5001000071290100; lbs=!w72RrdlKfHJ2EkASTJ/6Qo9WwVXjT6RD2J6cnWT8vBH3FpPu2R5IMHEyOqgLcSsr1ka983KHT5bwS5IESrLHcUTyyc99TzEYuj8UVrQ=",
